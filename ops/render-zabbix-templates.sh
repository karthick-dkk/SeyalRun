#!/bin/bash
# Renders core/monitoring/template-source.yaml (Zabbix 6.4 export format) into
# core/monitoring/zabbix-templates/7.0/ and /8.0/, each importable as-is.
#
...
SRC="core/monitoring/template-source.yaml"
[[ -f "$SRC" ]] || { echo "Missing $SRC" >&2; exit 1; }

for ver in 7.0 8.0; do
  OUT_DIR="core/monitoring/zabbix-templates/${ver}"
